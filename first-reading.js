...
(() => {
  ...
  leaf('first-arrival','I fight Routine',`${mark('MarginaliaGoblinReading')}<p class="eyebrow">Now the part I care about</p><h2>I fight Routine.</h2><p>It keeps telling you that you’ve seen all this before.</p><p>Your street. Your breakfast. The people you love. I want you to catch something you would have walked past.</p><p>One small thing will do. You don’t owe me your whole day.</p>${link('first-write','Catch something now')}<p class="reading-whisper">Or turn the Page. I’ve left things for you to try.</p>`,'arrival');
