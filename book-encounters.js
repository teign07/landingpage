...
(() => {
  ...
  const slips={
    ...
    remembered:{title:'The Book chose a favorite',html:`${mark('MarginaliaSeal')}<p class="eyebrow">The Book brought this back</p><h2>I Chose a Favorite</h2><blockquote class="kept-sentence">Just chilling this morning when I would usually be working; it’s amazing.</blockquote><div class="book-reply"><p>This one.</p><p>It is small and exact. It does not waste a word.</p></div>${note('A real returned Page: the reader’s sentence above, the Book’s response below. Prepared here from the maker’s Book.')}`},
